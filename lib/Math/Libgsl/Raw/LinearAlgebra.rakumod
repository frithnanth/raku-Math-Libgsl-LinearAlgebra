...
unit module Math::Libgsl::Raw::LinearAlgebra:ver<0.0.1>:auth<cpan:FRITH>;
...
sub gsl_linalg_cholesky_decomp(gsl_matrix $A --> int32) is native(LIB) is export(:cholesky) { * }
...
sub gsl_linalg_hessenberg_submatrix(gsl_matrix $H, gsl_matrix $a, size_t $top, gsl_vector $tau --> int32) is native(LIB) is export(:hessenberg) { * }
...
sub mgsl_linalg_complex_householder_transform(gsl_vector $w, gsl_complex $res --> num64) is native(LIB) is export(:householder) { * }
sub gsl_linalg_householder_hm(num64 $tau, gsl_vector $v, gsl_matrix $A --> int32) is native(LIB) is export(:householder) { * }
sub gsl_linalg_complex_householder_hm(gsl_complex $tau, gsl_vector_complex $v, gsl_matrix_complex $A --> int32) is native(LIB) is export(:householder) { * }
sub gsl_linalg_householder_mh(num64 $tau, gsl_vector $v, gsl_matrix $A --> int32) is native(LIB) is export(:householder) { * }
sub gsl_linalg_complex_householder_mh(gsl_complex $tau, gsl_vector_complex $v, gsl_matrix_complex $A --> int32) is native(LIB) is export(:householder) { * }
sub gsl_linalg_householder_hv(num64 $tau, gsl_vector $v, gsl_vector $w --> int32) is native(LIB) is export(:householder) { * }
sub gsl_linalg_complex_householder_hv(gsl_complex $tau, gsl_vector_complex $v, gsl_vector_complex $w --> int32) is native(LIB) is export(:householder) { * }
...
sub gsl_linalg_complex_tri_LTL(gsl_matrix_complex $L --> int32) is native(LIB) is export(:triang) { * }
...
sub gsl_linalg_balance_accum(gsl_matrix $A, gsl_vector $D --> int32) is native(LIB) is export(:banlance) { * }
sub gsl_linalg_balance_columns(gsl_matrix $A, gsl_vector $D --> int32) is native(LIB) is export(:banlance) { * }
